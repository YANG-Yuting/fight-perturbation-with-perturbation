...
task = 'fake'
vocab_size = 50000
with open('data/adversary_training_corpora/%s/dataset_%d.pkl' % (task, vocab_size), 'rb') as fh:
    dataset = pickle.load(fh)

hownet_dict = OpenHowNet.HowNetDict()

f = open('data/adversary_training_corpora/%s/sss_dict.pkl' % task, 'rb')
...
f = open('data/adversary_training_corpora/%s/word_candidates_sense_all.pkl' % task, 'wb')
