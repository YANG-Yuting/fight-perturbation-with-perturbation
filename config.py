...
parser.add_argument("--embedding", type=str, default='dataset/glove.6B/glove.6B.200d.txt', help="word vectors")
parser.add_argument("--counter_fitting_embeddings_path",type=str,default='dataset/counter-fitted-vectors.txt',help="path to the counter-fitting embeddings we used to find synonyms")
# parser.add_argument("--counter_fitting_cos_sim_path",type=str,default='dataset/cos_sim_counter_fitting.npy',help="pre-compute the cosine similarity scores based on the counter-fitting embeddings")
parser.add_argument("--USE_cache_path",type=str,default='',help="Path to the USE encoder cache.")
parser.add_argument("--output_dir",type=str,default='adv_results',help="The output directory where the attack results will be written.")
...
parser.add_argument("--target_model_path",type=str,default='models/wordLSTM/mr',help="pre-trained target model path")
...
parser.add_argument("--data_path", type=str, default="dataset/", help="where to load dataset, parent dir")
...
parser.add_argument("--save_path", type=str, default='', help='path to store trained model')
...
args.embedding = args.data_path + 'glove.6B/glove.6B.200d.txt'
...
if args.sym:
    ...
    with open(args.data_path + '%s/word_candidates_sense_top5.pkl' % args.task, 'rb') as fp:
        args.word_candidate = pickle.load(fp)
