...
def train_model(args, epoch, model, optimizer,train_data, test_data, best_test, save_path):
    for e in range(epoch):
        train_acc = trainepoch(epoch,model,optimizer,train_data)
...
torch.save(nli_net.encoder.state_dict(), os.path.join(params.outputdir, params.outputmodelname + '_new.encoder.pkl'))
